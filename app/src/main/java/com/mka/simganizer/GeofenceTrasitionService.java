...
public class GeofenceTrasitionService extends IntentService {
    ...
    private String getGeofenceTrasitionDetails(int geoFenceTransition, List<com.google.android.gms.location.Geofence> triggeringGeofences) {
    ...
    private void sendNotification( String msg ) {
        ...
        Intent notificationIntent = LocateCompany.makeNotificationIntent(
                getApplicationContext(), msg
        );

        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);
        stackBuilder.addParentStack(LocateCompany.class);
    ...
    private Notification createNotification(String msg, PendingIntent notificationPendingIntent) {
        ...
        notificationBuilder
                ...
                .setColor(Color.RED)
                .setContentTitle(msg)
                .setContentText("LocateCompany Notification!")
