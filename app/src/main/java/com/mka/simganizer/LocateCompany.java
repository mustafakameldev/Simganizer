...
public class LocateCompany extends AppCompatActivity
    ...
    private static final    String TAG = LocateCompany.class.getSimpleName();
    ...
    public static Intent makeNotificationIntent(Context context, String msg) {
        Intent intent = new Intent( context, LocateCompany.class );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_locate_company);
    ...
    private void startGeofence() {
        ...
        if( geoFenceMarker != null ) {
            ...
            Log.e(TAG, "LocateCompany marker is null");
        }
    }

    private static final long GEO_DURATION = 60 * 60 * 1000;
    private static final String GEOFENCE_REQ_ID = "My LocateCompany";
